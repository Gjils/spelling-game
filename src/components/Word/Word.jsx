...
export default class Word extends Component {
	...
	render() {
		...
		const { answered, chosen, handled, correct } = this.props.answerStatus;
		...
		if (answered && missedLetter !== chosen) {
			optionsContent = (
		...
		return (
			<>
				<div
					className={`word ${handled ? "fadeout" : ""} ${
						correct === false && !handled ? "shaking" : ""
					}`}
				>
